...
const OurCourses = () => {
 ...
 useEffect(()=>{
  ...
  return (
    <>
    <div className="gsname h-auto">
      <h1 className='gs text-blue-800 font-bold flex gap-2 text-[2rem] justify-center px-[10vw] md:flex-col md:text-[4rem]'>OUR <span className='text-red-800 font-bold'> COURSES</span></h1> </div>
    <div className="gs boxes w-full flex justify-center items-center flex-wrap h-auto p-8 sm:flex gap-10 ">
        ...
        <div className="top h-[300px]  flex items-center justify-center rotate-[-90deg] whitespace-nowrap group-hover:hidden">
          <h1 className='gs text-[30px] font-bold text-blue-800 transition duration-500 ease-in-out'>BASIC LEARNING</h1>
        </div>
