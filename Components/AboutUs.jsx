...
const AboutUs = () => {
  ...
  return (
    <>
    <div className='main  flex flex-col justify-center items-center md:flex mb-8 p-8'>
      ...
      <img className='md:w-[40vw]' src="/about1.svg" alt=""/>
      <div className="img pl-6 flex-col-reverse pt-4   md:flex-col-reverse   ">
      <img className='w-[100vw] md:w-[25vw] ' src="/about2.svg" alt=""/>
       
        <p className='txtAbt text-[15px] md:text-[1vw]'> <span className="text-red-800 font-bold"> #WHO WE ARE  </span><br />Dedicated to transforming your English <br /> learning experience with innovation and <br />passion.</p>
        </div>
